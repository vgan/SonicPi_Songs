...
define :mission_impossible do
  sample :drum_tom_lo_hard,amp: choose([1,1.1,1.2,1.5,2])
  sample :drum_tom_hi_hard,amp: choose([1,1.1,1.2,1.5,2])
  sample choose([:drum_cymbal_hard,:drum_cymbal_open,:drum_cymbal_soft,:drum_cymbal_closed])
  sleep 1.5
  sample :drum_tom_lo_hard,amp: choose([1,1.1,1.2,1.5,2])
  sample :drum_tom_hi_hard,amp: choose([1,1.1,1.2,1.5,2])
  sleep 0.5
...
live_loop :drumsolomatic do
  sleep choose([5,10])
  choose([mission_impossible,paradiddle_quarters,paradiddle_8ths,paradiddle_toms,fill1])
end
